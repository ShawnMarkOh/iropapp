document.addEventListener('DOMContentLoaded', () => {
    ...
    if (importForm && importStatusEl && dbFileInput && importModalEl) {
        importForm.addEventListener('submit', async (e) => {
            ...
            importStatusEl.style.display = 'block';
            importStatusEl.innerHTML = `<div class="alert alert-info"><div class="spinner-border spinner-border-sm me-2" role="status"></div>Uploading and processing file... This may take a moment.</div>`;
